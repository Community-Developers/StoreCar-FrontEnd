...
export class AdminService {
  ...
  public getAllCars(): Observable<Car[]> {
    ...
    return this.http.get<{ content: Car[] }>('http://18.220.168.177:80/veiculo').pipe(
      map(res => res.content)
    );
  }
  public getAllMobi(): Observable<Moto[]> {
    return this.http.get<{ content: Moto[] }>('http://18.220.168.177:80/motocicleta').pipe(
      map(res => res.content)
    );
  }
  //=========== GET ALL SERVER ================
  ...
  public getDestaquesMobi(): Observable<Moto[]> {
    return this.http.get<{ content: Moto[] }>('http://18.220.168.177:80/motocicleta/destaques').pipe(
      map(res => res.content)
    );
  }
  ...
  post(formData: FormData) {
    ...
    return this.http.post('http://18.220.168.177:80/veiculo', formData, { headers })
  }

  postMoto(formData: FormData) {
    const headers = this.fetchData();
    return this.http.post('http://18.220.168.177:80/motocicleta', formData, { headers })
  }
  //===========POST SERVER ================
  ...
  getItem(type: string, id: any): Observable<any> {
    return this.http.get(`http://18.220.168.177:80/${type}/${id}`);
  }
  //=========== GET ITEM SERVER ================
  ...
  public deleteImageCarro(id: string, nameObject: string): Observable<any> {
    const headers = this.fetchData();
    return this.http.delete(`http://18.220.168.177:80/veiculo/delete-images/${id}/${nameObject}`, { headers });
  }

  public deleteImageMoto(id: string, nameObject: string): Observable<any> {
    const headers = this.fetchData();
    return this.http.delete(`http://18.220.168.177:80/motocicleta/delete-images/${id}/${nameObject}`, { headers });
  }
  //=========== DELETE IMAGE SERVER ================
  ...
  public updateMobi(id: any, value: any): Observable<any> {
    return this.http.put(`http://18.220.168.177:80/motocicleta/${id}`, value, { headers: this.fetchData() });
  }

  public updateCarro(id: number, value: any): Observable<any> {
    return this.http.put(`http://18.220.168.177:80/veiculo/${id}`, value, { headers: this.fetchData() });
  }
  //================= UPDATE SERVER ============================
  ...
  public deleteItem(idItem: number, type: string): Observable<any> {
    const headers = this.fetchData();
    return this.http.delete(`http://18.220.168.177:80/${type}/${idItem}`, { headers });
  }
  //================= DELETE ITEM SERVER ============================
  ...
  saveNewImages(formData: FormData, type: string, id: string,): Observable<any> {
    return this.http.post(`http://18.220.168.177:80/${type}/save-images/${id}`, formData, { headers: this.fetchData() });
  }
  //================= SAVE NEW IMAGES ============================
